            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="flex space-x-4">
                    ...
                    <Link to='/' className="flex items-center py-5 px-2 text-gray-700 hover:text-gray-900">
                        ...
                        <span className="font-bold text-2xl">Storage Cart App</span>
                    </Link>
                    </div>
            
                {/*  <!-- primary nav --> */}
                    <div className="hidden md:flex items-center space-x-1">
                    <NavLink to='/' className="py-5 px-3 text-gray-700 hover:text-gray-900">Home</NavLink>
                    <NavLink to="/shop" className="py-5 px-3 text-gray-700 hover:text-gray-900">Shop</NavLink>
                    </div>
                </div>
